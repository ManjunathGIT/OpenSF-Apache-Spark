# Databricks notebook source exported at Tue, 11 Oct 2016 20:17:04 UTC
...
fireServiceDF.write.format('parquet').save('/tmp/fireServiceParquetnew/')
...
# MAGIC %fs ls /tmp/fireServiceParquetnew/
...
tempDF = spark.read.parquet('/tmp/fireServiceParquetnew/')
